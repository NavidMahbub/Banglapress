<template>
    <b-modal title="Contact" no-close-on-backdrop hide-footer size="xl"  v-model="modalOperate" @ok="largeModal = false">
        <form @submit.prevent="addContact">
            <div style="max-height:350px; overflow:auto" class="container custom_modal_body">
                ...
                <div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                        <input type="text" v-validate="'required|email'" data-vv-as="email" name="email_field"  v-model="newContact.email" class="form-control" id="inputPassword3" placeholder="Email">
